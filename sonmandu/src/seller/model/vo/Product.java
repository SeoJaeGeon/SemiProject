...
public class Product {
   ...
   private String experience;      // 판매 경험
...
public Product(String productName, int price, int charge, int stock, int productTime, String categoryKey) {
	super();
	this.productName = productName;
	this.price = price;
	this.charge = charge;
   ...
   public Product(int productId, String productName, int price, int stock, int productTime, int charge, String experience, String introduction,
   ...
   public String toString() {
      return "Product [productId=" + productId + ", productName=" + productName + ", price=" + price + ", stock=" + stock
            + ", productTime=" + productTime + ", charge=" + charge + ", experience=" + experience + ", introduction="
